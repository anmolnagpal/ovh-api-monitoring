...
$(document).ready(function () {
    /*var intervalAlert = window.setInterval(callBackAlert, (5*60)*1000);*/
    callBackAlert();
    /*var intervalStatus = window.setInterval(callBackStatus, (15*60)*1000);*/
    callBackStatus();
    /*var intervalDisk = window.setInterval(callBackDisk, (5*60)*1000);*/
    callBackDisk();
    /*var intervalCPU = window.setInterval(callBackCPU, (5*60)*1000);*/
    callBackCPU();
    /*var intervalRAM = window.setInterval(callBackRAM, (5*60)*1000);*/
    callBackRAM();
...
function callBackStatus() {
    $.getJSON("vps-xhr.php", {
        ...
        $("tr[data-vps]").each(function () {
            ...
            $(this).find(".badge.status-ping").removeClass(".badge-default .badge-success .badge-danger").addClass((status.ping === "up" ? "badge-success" : "badge-danger"));
            $(this).find(".badge.status-ssh").removeClass(".badge-default .badge-success .badge-danger").addClass((status.ssh.state === "up" ? "badge-success" : "badge-danger")).attr("title", "Port " + status.ssh.port);
            $(this).find(".badge.status-dns").removeClass(".badge-default .badge-success .badge-danger").addClass((status.dns.state === "up" ? "badge-success" : "badge-danger")).attr("title", "Port " + status.dns.port);
            $(this).find(".badge.status-http").removeClass(".badge-default .badge-success .badge-danger").addClass((status.http.state === "up" ? "badge-success" : "badge-danger")).attr("title", "Port " + status.http.port);
            $(this).find(".badge.status-https").removeClass(".badge-default .badge-success .badge-danger").addClass((status.https.state === "up" ? "badge-success" : "badge-danger")).attr("title", "Port " + status.https.port);
            $(this).find(".badge.status-smtp").removeClass(".badge-default .badge-success .badge-danger").addClass((status.smtp.state === "up" ? "badge-success" : "badge-danger")).attr("title", "Port " + status.smtp.port);


            $(this).find(".badge.status-tools").removeClass(".badge-default .badge-success .badge-danger").addClass((status.tools !== null ? (status.tools === "up" ? "badge-success" : "badge-danger") : "badge-default"));
        });
    });
}
